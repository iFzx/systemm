    ...
    :bulb: bots: ${message.guild.members.filter(m=>m.user.bot).size} **`)
          ...
          client.on("message", message => {
            ...
            **  『+move @user / لسحب الشخص الى روومك』
              ...
              『+vban / حظر من الروم الصوتي』
              『+vunban / إزالة الحظر من الروم الصوتي』
              『+voice / كم واحد في الروم الصوتي』
              『+role/ إطاء رتبه』
              『+role all / إعطاء الكل رتبه』
              『+role humands / إعطاء الأعضاء رتبه』
              『+role bots / إطعاء البوتات رتبه』
              『+unbanall / فك البان عن الجميع 』
              『+hide / إخفاء جميع الرومات الكتابية 』
              『+unhide / إعادة إضهارها 』
              『+tempmute / إعطاء ميوت بوقت 』
 ...
 if (message.member.voiceChannel == null) return;
  ...
  message.channel.send('\`Moved All Voice Members To Your Channel\`').then(m => m.delete(4000))
    ...
    client.on('message', eyad => {
      if (eyad.content.startsWith('+vunban')) {
